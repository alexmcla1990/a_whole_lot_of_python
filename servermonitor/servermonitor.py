...
class Server():
    ...
    def check_connection(self):
        ...
        try:
            ...
            msg = f'server: {self.port} is down. On port {self.port}'
        except (ConnectionRefusedError, ConnectionResetError) as e:
            msg = f'server: {self.port} {e}'
...
if __name__ == '__main__':
    try: 
        ...
        servers = [
            Server('app.contology.com', 80, 'plain', 'high'),
            Server('smtp.gmail.com', 465, 'ssl', 'high'),
            Server('qwiklabs.com', 80, 'plain', 'high'),
            Server('npr.org', 80, 'plain', 'high'),
            Server('reddit.com', 80, 'plain', 'high')
            #Server('1.1.1.1', 80, 'ping', 'high')
        ]

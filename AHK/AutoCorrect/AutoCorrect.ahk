...
;------------------------------------------------------------------------------
; CHANGELOG:
;  http://www.autohotkey-merchandise.com/Public/Udemy/Hotstrings/AutoCorrect.ahk
...
; INTRODUCTION
;
; This is an AutoHotKey script that implements AutoCorrect against several "Lists of common misspellings":
;
